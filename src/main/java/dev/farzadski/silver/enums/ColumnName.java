package dev.farzadski.silver.enums;
...
public enum ColumnName {
  ...
  IS_PASSENGER_COUNT_MISSING("IS_PASSENGER_COUNT_MISSING", "IS_PASSENGER_COUNT_MISSING"),
  IS_STORED_BEFORE_TRANSMISSION_FLAG_MISSING(
      "IS_STORED_BEFORE_TRANSMISSION_FLAG_MISSING", "IS_STORED_BEFORE_TRANSMISSION_FLAG_MISSING"),
  IS_STATE_CONGESTION_SURCHARGE_AMOUNT_USD_MISSING(
      "IS_STATE_CONGESTION_SURCHARGE_AMOUNT_USD_MISSING",
      "IS_STATE_CONGESTION_SURCHARGE_AMOUNT_USD_MISSING"),
  IS_AIRPORT_PICKUP_FEE_AMOUNT_USD_MISSING(
      "IS_AIRPORT_PICKUP_FEE_AMOUNT_USD_MISSING", "IS_AIRPORT_PICKUP_FEE_AMOUNT_USD_MISSING"),
  TRIP_DURATION_IN_MINUTES("TRIP_DURATION_IN_MINUTES", "TRIP_DURATION_IN_MINUTES");
