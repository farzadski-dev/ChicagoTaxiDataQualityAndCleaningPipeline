...
public class StateCongestionSurchargeAmountUsdRule implements IRule<Dataset<Row>> {

  @Override
  public Dataset<Row> apply(Dataset<Row> input) {

    String col = ColumnName.STATE_CONGESTION_SURCHARGE_AMOUNT_USD.canonical();
    String missingCol = ColumnName.IS_STATE_CONGESTION_SURCHARGE_AMOUNT_USD_MISSING.canonical();
